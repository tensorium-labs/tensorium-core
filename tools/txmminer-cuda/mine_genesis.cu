...
static void build_genesis_header(uint8_t hdr[122]) {
    ...
    // Merkle root — tokenomics v2 (8M pre-mint: founder 1M + liquidity 3M + bridge 2M + eco 2M)
    // Verified from: tensorium-node mainnet-candidate mine-genesis 1 (2026-06-02)
    // d0b4dfd2a297b7aaa476c2c7dba4fc31e1fe2a8917e98c63510649f248ad3bf2
    const uint8_t merkle[32] = {
        0xd0,0xb4,0xdf,0xd2,0xa2,0x97,0xb7,0xaa,
        0xa4,0x76,0xc2,0xc7,0xdb,0xa4,0xfc,0x31,
        0xe1,0xfe,0x2a,0x89,0x17,0xe9,0x8c,0x63,
        0x51,0x06,0x49,0xf2,0x48,0xad,0x3b,0xf2,
    };
