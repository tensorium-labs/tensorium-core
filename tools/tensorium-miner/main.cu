...
//
// Usage: tensorium-miner <rpc_host:port> <miner_address> [device_id] [blocks] [threads]
//
// Example:
//   tensorium-miner 127.0.0.1:33332 txm1youraddress
//   tensorium-miner 127.0.0.1:33332 txm1youraddress 0 1024 256
...
int main(int argc, char *argv[]) {
    ...
    printf("tensorium-miner — device=%s blocks=%d threads=%d\n",
