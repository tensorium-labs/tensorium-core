...
print_summary() {
    ...
    echo -e "    ${CYAN}# Solo mining against the canonical public RPC:${NC}"
    echo -e "    ${CYAN}./tensorium-miner --mode solo --rpc https://rpc.tensoriumlabs.com --wallet ${miner_addr} --gpu all${NC}"
    echo -e "    ${CYAN}# Compatibility alias still exists: http://mc-rpc.tensoriumlabs.com${NC}"
    echo ""
